!(function (n) {
    function t(t, c) {
        ...
        if (
            ...
            void 0 != c.regexpMatchFormat &&
                ...
                ((window["regexpMatchFormat_" + t.attr("id")] =
                    c.regexpMatchFormat),
                (window["regexpReplaceWith_" + t.attr("id")] =
                    c.regexpReplaceWith)),
        ...
        if (
            ...
            if (
                ...
                (startDate = ""),
                    (endDate = ""),
                    (timer_startDate = ""),
                    (window["startDate" + t.attr("id")] = new Date(
                        S.startDate
                    )),
                    (window["endDate" + t.attr("id")] = new Date(
                        S.dateAndTime
                    ));
                var p = "withStart";
                a(t, S, p),
                    (window["timer_startDate" + t.attr("id")] = setInterval(
                        function () {
                            a(t, S, p);
                        },
                        1e3 * S.tickInterval
                ...
                (window["startTime" + t.attr("id")] = new Date(
                    ...
                    (window["dateTime" + t.attr("id")] = new Date(
                        S.dateAndTime
                    ));
                var p = "withnoStart";
                a(t, S, p),
                    (window["timer_givenDate" + t.attr("id")] = setInterval(
                        function () {
                            a(t, S, p);
                        },
                        1e3 * S.tickInterval
                ...
                void 0 != c.currentTime
                    ...
                    : ((countSeconds = ""),
                      ...
                      (window["timer_secondsTimer" + t.attr("id")] =
            ...
            void 0 != c.hours && void 0 == c.minutes && void 0 == c.seconds
                ...
                : void 0 != c.hours &&
                  ...
                  r(t, S),
                  (window["timer_HMS" + t.attr("id")] = setInterval(
                      function () {
                          r(t, S);
                      },
                      1e3 * S.tickInterval
    ...
    function o(n, t) {
        var e = n.attr("id");
        window["minutes_M" + e] == t.minutes &&
        window["seconds_M" + e] == t.seconds
    ...
    function w(n, t) {
        var e = n.attr("id");
        window["minutes_HM" + e] == t.minutes &&
        window["hours_HM" + e] == t.hours
            ...
            "resume" != n(this).val()
                ...
                : "resume" == n(this).val() &&
                  (n("#" + o.pauseButton)
                      .val("pause")
                      .text("Pause"),
                  (window["timer_" + e + t.attr("id")] = setInterval(
                      function () {
                          i(t, o);
                      },
                      1e3 * o.tickInterval
